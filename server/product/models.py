...
class Product(models.Model):
    ...
    sku = models.CharField(max_length=10, help_text="Enter Stock Keeping Unit")
    name = models.CharField(max_length=200, help_text="Enter product name")
    description = models.TextField(help_text="Enter product description")

    buyPrice = models.DecimalField(
        decimal_places=2, max_digits=25, help_text="Enter product price per unit")
    ...
    quantity = models.DecimalField(
        decimal_places=1, max_digits=25, help_text="Enter quantity")
